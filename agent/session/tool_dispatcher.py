...
def build_gemini_tools(mcp_tools: Dict[str, Any], call_queues: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    rag_decl = {
        ...
        "description": (
            "البحث الذكي في قاعدة المعرفة والمستندات والملفات المرفوعة الخاصة بهذا المتجر أو المؤسسة. "
            "استدعِ هذه الأداة للبحث والإجابة عن أي تفاصيل أو شروط أو سياسات أو معلومات مذكورة في مستندات المستخدم."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
